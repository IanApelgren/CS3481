...
import solution.SuitsAndRanks.Rank;
import solution.SuitsAndRanks.Suit;
...
public class Deck 
{
    ...
    public ArrayList<PlayingCard> deck = new ArrayList<PlayingCard>(NUM_CARDS);
    /**
    ...
    public void initialize() 
    {
        ...
        for (int i = 0; i < SuitsAndRanks.NUMRANKS; i++)
        {
            ...
            {
                x = SuitsAndRanks.fetchRank(i);
                y = SuitsAndRanks.fetchSuit(j);
                PlayingCard card = new PlayingCard(x, y);
                deck.add(card);
                //count++;
            }
        }
    ...
    {    
        ...
        for (int index = NUM_CARDS - 1; index > 0; index--)
        {
            ...
            // TODO: swap
            PlayingCard swapCard = deck.get(cardPos);
            PlayingCard endCard = deck.get(index);
            deck.set(cardPos, endCard);
            deck.set(index, swapCard);
        }
    }
    /**
