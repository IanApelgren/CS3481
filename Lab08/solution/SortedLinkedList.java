    ...
    implements Iterable<T>
{
    ...
    {
        SortedLinkedList<T>.MyIterator iterator = new MyIterator();
        return iterator;
    }
    ...
    private class MyIterator implements Iterator<T>
    {
        ...
        public void remove()
        {
            throw new UnsupportedOperationException("remove has not be implemented");
        }
